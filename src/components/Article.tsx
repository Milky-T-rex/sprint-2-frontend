...
const Article: React.FC = () => {
  ...
  if (!article) {
    return (
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h1 className="text-4xl font-semibold text-center text-gray-900 mt-14">ไม่พบบทความ</h1>
        <button
          onClick={() => navigate(-1)}
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
      <h1 className="text-4xl font-semibold text-center text-gray-900 mt-14">{article.title}</h1>  
